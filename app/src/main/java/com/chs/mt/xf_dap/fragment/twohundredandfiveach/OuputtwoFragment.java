package com.chs.mt.xf_dap.fragment.twohundredandfiveach;
...
public class OuputtwoFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.chs_fragment_output_two, null);
            ...
            switch (i) {
                case 0:
                    if (DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].HP_OFF_Flg == 1) {
                        v_xoverItems[i].btn_type.setText(String.valueOf(20) + "Hz");
                        v_xoverItems[i].btn_type.setTextColor(getResources().getColor(R.color.gray));
                    } else {
                        v_xoverItems[i].btn_type.setText(String.valueOf(DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_freq) + "Hz");
                        v_xoverItems[i].btn_type.setTextColor(getResources().getColor(R.color.freqcolor));
                    }
                ...
                case 1:
                    ...
                    } else if (DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_level == 0 && DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].HP_OFF_Flg == 1) {
                ...
                case 2:
                    if (DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].HP_OFF_Flg == 1) {
                        v_xoverItems[i].btn_type.setText(DataStruct.CurMacMode.XOver.Level.memberName1[8]);
                    } else {
                ...
                case 3:
                    if (DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].LP_OFF_Flg == 1) {
                        v_xoverItems[i].btn_type.setText(String.valueOf(20000) + "Hz");
                        v_xoverItems[i].btn_type.setTextColor(getResources().getColor(R.color.gray));
                    } else {
                ...
                case 4:
                    ...
                    } else if (DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_level == 0 && DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].LP_OFF_Flg == 1) {
                        v_xoverItems[i].btn_type.setText(getResources().getString(R.string.NULL));
                    } else {
                        v_xoverItems[i].btn_type.setText(getResources().getString(R.string.NULL));
                    }
...
//        ly_link = view.findViewById(R.id.id_ly_link_output);
    ...
    private void showFreq(final int index) {//index==0 高通  index==1 低通
        ...
        if (index == 0) {
            if (DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].LP_OFF_Flg == 1) {
                Freq.putInt(SetFreqDialogFragment.ST_LP_Freq, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].LP_OFF_Freq);
            }

        } else {
            if (DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].HP_OFF_Flg == 1) {
                Freq.putInt(SetFreqDialogFragment.ST_HP_Freq, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].HP_OFF_Freq);
            }
        }
        ...
        otcDialog.OnSetOnClickDialogListener(new oct_selectDialogFragment.SetOnClickDialogListener() {
            ...
            public void onClickDialogListener(int type, boolean boolClick) {
                ...
                if (index == 0) {
                    ...
                    if (type == DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_level) {
                        return;
                    }

                    if (type == 8) {
                        DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].HP_OFF_Flg = 1;
                        DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].HP_OFF_Freq = DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_freq;
                        DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_freq = 20;
                    } else {
                        if (DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].HP_OFF_Flg == 1) {
                            DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_freq = DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].HP_OFF_Freq;
                            MacCfg.UI_Type = Define.UI_HFreq;
                            DataOptUtil.syncLinkData();
                        }
                        DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].HP_OFF_Flg = 0;
                    }
                    ...
                    if (type == DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_level) {
                        return;
                    }

                    if (type == 8) {
                        DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].LP_OFF_Flg = 1;
                        DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].LP_OFF_Freq = DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_freq;
                        DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_freq = 20000;
                    } else {
                        if (DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].LP_OFF_Flg == 1) {
                            DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_freq = DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].LP_OFF_Freq;
                            MacCfg.UI_Type = Define.UI_LFreq;
                            DataOptUtil.syncLinkData();
                        }
                        DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].LP_OFF_Flg = 0;
                    }
                ...
                public void onClick(View v) {   //+按钮
                    ...
                    switch (index) {
                        case 0:
                            ...
                            ReturnFuncation.setFreq(true, DataOptUtil.HFreq(true, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_freq));
                            MacCfg.UI_Type = Define.UI_HFreq;
                            DataOptUtil.syncLinkData();
                            break;
                        case 3:
                            ...
                            ReturnFuncation.setFreq(false, DataOptUtil.HFreq(true, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_freq));
                            ...
                            break;
                        case 2:
                            if (DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_level == DataStruct.CurMacMode.XOver.Level.max1 - 1) {
                                return;
                            } else if (DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_level == 0 && DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].HP_OFF_Flg == 1) {
                                return;
                            }
                            ...
                            if (MacCfg.Mcu == 7) {
                                // System.out.println("BUG 这个的值为"+DataOptUtil.fiftyOct(true, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_level,DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].HP_OFF_Flg));
                                //if(DataOptUtil.fiftyOct(true, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_level,DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].HP_OFF_Flg)!=9){
                                DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_level = DataOptUtil.fiftyOct(true, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_level, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].HP_OFF_Flg);
                                //}
                            } else {
                            ...
                            break;
                        case 5:
                            if (DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_level == DataStruct.CurMacMode.XOver.Level.max1 - 1) {
                                return;
                            } else if (DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_level == 0 && DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].HP_OFF_Flg == 1) {
                                return;
                            }
                            if (MacCfg.Mcu == 7) {
                                // DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_level = DataOptUtil.fiftyOct(true, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_level, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].LP_OFF_Flg );
                ...
                public void onClick(View v) {
                    ...
                    switch (index) {
                        ...
                        case 0:
                            ...
                            //  DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_freq = DataOptUtil.HFreq(false, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_freq);

                            ReturnFuncation.setFreq(true, DataOptUtil.HFreq(false, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_freq));
                            MacCfg.UI_Type = Define.UI_HFreq;
                            DataOptUtil.syncLinkData();
                            break;
                        case 3:
                            ...
                            ReturnFuncation.setFreq(false, DataOptUtil.HFreq(false, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_freq));
                            // DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_freq = DataOptUtil.HFreq(false, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_freq);
                            MacCfg.UI_Type = Define.UI_LFreq;
                            DataOptUtil.syncLinkData();
                            break;
                        ...
                        case 2:
                            ...
                            if (MacCfg.Mcu == 7) {
                                DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_level = DataOptUtil.fiftyOct(false, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_level, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].HP_OFF_Flg);
                                if (DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].h_level != DataStruct.CurMacMode.XOver.Level.max1 - 1) {
                                    DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].HP_OFF_Flg = 0;
                                }
                            } else {
                        ...
                        case 5:
                            ...
                            if (MacCfg.Mcu == 7) {
                                DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_level = DataOptUtil.fiftyOct(false, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_level, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].LP_OFF_Flg);
                                if (DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_level != DataStruct.CurMacMode.XOver.Level.max1 - 1) {
                                    DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].LP_OFF_Flg = 0;
                                }
                            } else {
                            ...
                            //                            if( DataOptUtil.HFilter(false, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_level, Define.L_Type)==2){
//                                DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_level =8;
//                            }else{
//                                DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_level =DataOptUtil.HFilter(false, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_level, Define.L_Type);
//                            }
                        ...
                        case 4:
                            ...
                            if (DataOptUtil.HFilter(false, DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_filter, Define.L_Type) == 2) {
                                DataStruct.RcvDeviceData.OUT_CH[MacCfg.OutputChannelSel].l_filter = 8;
                            } else {
        ...
        for (int i = 0; i < v_xoverItems.length; i++) {
            switch (i) {
                ...
                case 1:
                case 4:
                    v_xoverItems[i].btn_type.setTextColor(getResources().getColor(R.color.filtercolor));
                    break;
                case 2:
                case 5:
                    v_xoverItems[i].btn_type.setTextColor(getResources().getColor(R.color.octcolor));
                    break;
            }
...
//    }
    ...
    private void setLinkBtnState(boolean Link) {
        if (Link) {
            ...
            // btn_spk_type.setTextColor(getResources().getColor(R.color.output_channel_set_text_color_normal));
        }
    }
...
//	    			channelNameNumEls=GetChannelNum(B_OutName[j].getText().toString());
    ...
    private void setPolar(int index) {
        if (index == 0) {
            ...
            btnpolar.setTextColor(mcontext.getResources().getColor(R.color.white));
            ...
            btnpolar.setTextColor(mcontext.getResources().getColor(R.color.polar_press));
