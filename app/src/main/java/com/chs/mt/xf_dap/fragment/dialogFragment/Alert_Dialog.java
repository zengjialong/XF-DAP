...
public class Alert_Dialog {
    ...
    public Alert_Dialog builder() {
        View view = LayoutInflater.from(context).inflate(
                R.layout.chs_like_ios_dialog, null);
     ...
     * @return
     */
    public Alert_Dialog setTitle(String title) {
        showTitle = true;
     ...
     * @return
     */
    public Alert_Dialog setMsg(String msg) {
        showMsg = true;
     ...
     * @return
     */
    public Alert_Dialog setCancelable(boolean cancel) {
     ...
     * @return
     */
    public Alert_Dialog setPositiveButton(String text,
                                          final OnClickListener listener) {
        return setPositiveButton(text, -1, listener);
    }

    public Alert_Dialog setPositiveButton(String text, int color,
                                          final OnClickListener listener) {
        showPosBtn = true;
        if ("".equals(text)) {
            btn_pos.setText("");
    ...
    public Alert_Dialog setNegativeButton(String text,
                                          final OnClickListener listener) {

        return setNegativeButton(text, -1, listener);
    }

    public Alert_Dialog setNegativeButton(String text, int color,
                                          final OnClickListener listener) {
        showNegBtn = true;
        if ("".equals(text)) {
            btn_neg.setText("");
