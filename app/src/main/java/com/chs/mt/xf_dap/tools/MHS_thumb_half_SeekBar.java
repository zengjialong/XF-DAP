...
public class MHS_thumb_half_SeekBar extends View {
    ...
    public MHS_thumb_half_SeekBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    public MHS_thumb_half_SeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        mAttrs = attrs;
        initView();
    ...
    public MHS_thumb_half_SeekBar(Context context) {
        super(context);
        mContext = context;
        initView();
    }
    ...
    private void initView(){
        ...
        @SuppressLint("ResourceAsColor") int progressBackgroundColor = localTypedArray.getColor(R.styleable.mhsb_seekbar_mhs_progress_background_color, color.darker_gray);
...
//
      if(mSeekBarMax==112.0){//表示为低通频率
            if(mCurrentProgress<= DataOptUtil.getMinSubFreq()){
                mCurrentProgress=DataOptUtil.getMinSubFreq();
            }
        }
        mhsprogress_set= mhsSeekbarLong/mSeekBarMax*mCurrentProgress;
...
//    	RectF_mhsprogress = new RectF(sb_left,top,p_top,bottom);
    ...
    public interface OnMSBSeekBarChangeListener {
        ...
        public abstract void onProgressChanged(MHS_thumb_half_SeekBar mhs_SeekBar,
