...
public class HorizontalSelectedView extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        this.selectedColor = tta.getColor(R.styleable.HorizontalselectedView_HorizontalselectedViewSelectedTextColor, getResources().getColor(R.color.red));
        this.textSize = tta.getFloat(R.styleable.HorizontalselectedView_HorizontalselectedViewTextSize, 40.0F);
        this.textColor = tta.getColor(R.styleable.HorizontalselectedView_HorizontalselectedViewTextColor, this.context.getResources().getColor(R.color.white));
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                float scrollX = event.getX() - this.downX ;
